...
*/
	...
	function initThree() {
		...
		pathTracingScene = globals.scene;
	...
	async function prepareGeometryForPT(meshList, pathTracingMaterialList, triangleMaterialMarkers) 
	{
		...
		pathTracingUniforms.uResolution.value.x = renderer.getContext().drawingBufferWidth;
		pathTracingUniforms.uResolution.value.y = renderer.getContext().drawingBufferHeight;
