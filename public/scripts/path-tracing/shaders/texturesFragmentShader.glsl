...
// all textures in one array
uniform sampler2D u_textures[MAX_TEXTURES_IN_ARRAY]; 
...
//-----------------------------------------------------------------------
vec4 getTexturePixel(int index, vec2 uv)
//-----------------------------------------------------------------------
{
	switch(index)
	{
		case 0:
			return getPixel(u_textures[0], uv);

		case 1:
			return getPixel(u_textures[1], uv);

		case 2:
			return getPixel(u_textures[2], uv);

		case 3:
			return getPixel(u_textures[3], uv);

		case 4:
			return getPixel(u_textures[4], uv);

		case 5:
			return getPixel(u_textures[5], uv);

		case 6:
			return getPixel(u_textures[6], uv);

		case 7:
			return getPixel(u_textures[7], uv);

		case 8:
			return getPixel(u_textures[8], uv);

		case 9:
			return getPixel(u_textures[9], uv);
	}
...
//-----------------------------------------------------------------------
{
	...
	tmp = getPixel(inColor0, pixelPosInt.x, pixelPosInt.y);
	int textureIndex = int(tmp.x);
	vec2 uv = tmp.yz;

	outColor0 = getTexturePixel(textureIndex, uv);
	/*outColor1 = getPixel(inColor1, pixelPosInt.x, pixelPosInt.y);
	outColor2 = getPixel(inColor2, pixelPosInt.x, pixelPosInt.y);*/



	outColor1 = vec4(1, .5, .3, .7);
	outColor2 = vec4(1, .5, .3, .7);
