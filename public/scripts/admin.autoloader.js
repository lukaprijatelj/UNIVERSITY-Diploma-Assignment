(async () =>
{
	...
	loadingBlock.push(new namespace.core.AsyncImporter('scripts/debug.js'));
	loadingBlock.push(new namespace.core.AsyncImporter('scripts/api.js'));
	loadingBlock.push(new namespace.core.AsyncImporter('scripts/admin.events.js'));
	loadingBlock.push(new namespace.core.AsyncImporter('scripts/admin.js'));
	await Promise.all(loadingBlock);
