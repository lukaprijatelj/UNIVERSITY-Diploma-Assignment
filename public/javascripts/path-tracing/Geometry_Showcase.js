...
function initPathTracingShaders() {
        ...
        fileLoader.load('javascripts/shaders/common_PathTracing_Vertex.glsl', function (shaderText) {
...
function createPathTracingMaterial() {
        ...
        fileLoader.load('javascripts/shaders/Geometry_Showcase_Fragment.glsl', function (shaderText) {
