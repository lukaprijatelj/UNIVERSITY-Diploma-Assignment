...
function initPathTracingShaders() 
{
	...
	fileLoader.load('./javascripts/path-tracing/shaders/common_PathTracing_Vertex.glsl', (shaderText) => 
	{
...
{
	fileLoader.load('./javascripts/path-tracing/shaders/Geometry_Showcase_Fragment.glsl', (shaderText) =>
	{
